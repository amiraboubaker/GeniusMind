import 'package:courskids/dashboard/src/helper/courseModel.dart';
import 'package:courskids/dashboard/src/helper/quad_clipper.dart';
import 'package:courskids/dashboard/src/theme/color/light_color.dart';
import 'package:courskids/dashboard/src/theme/theme.dart';
...
class FavoritesPage extends StatelessWidget {
  ...
  Widget _header(BuildContext context) {
    ...
    // Adjust header height to prevent overflow
    double headerHeight = 150; // Or adjust according to your needs
    return ClipRRect(
  ...
  Widget _courceInfo(BuildContext context, CourseModel model, Widget decoration,
    ...
    return Container(
      height: 250, // Adjust based on content size
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: <Widget>[
                  SizedBox(height: 15),
                  Container(
                    height: 258.0, // Adjust based on estimated content size
                    child: Column(
                      children: <Widget>[
                        Container(
                          child: Row(
                            ...
                            children: <Widget>[
                              ...
                              Text(model.noOfCource,
                                  style: TextStyle(
                                      color: LightColor.grey, fontSize: 14)),
                              SizedBox(width: 10)
                            ],
                          ),
                        ),
                        Text(model.university,
                            style: AppTheme.h6Style.copyWith(
                                fontSize: 12, color: LightColor.grey)),
                        SizedBox(height: 15),
                        Text(
                          model.description,
                          maxLines: 3,
                        ...
                        Row(
                          children: <Widget>[
                            Flexible(
                              child: _chip(model.tag1, LightColor.darkOrange,
                                  height: 5),
                            ),
                            SizedBox(width: 10),
                            Flexible(
                              child: _chip(model.tag2, LightColor.seeBlue,
                                  height: 5),
                            ),
                          ],
                        )
        ...
        body: SingleChildScrollView(
          child: Column(
            children: <Widget>[
              _header(context),
              SizedBox(height: 20),
              _categoryRow(context, "Favorites"),
              _courseList(context)
            ],
          ),
        ),
  ...
  return Container(
    ...
    child: Row(
      ...
      children: <Widget>[
        ...
        Icon(Icons.arrow_forward_ios, color: LightColor.grey)
      ],
    ),
  );
}
